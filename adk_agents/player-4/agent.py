...
logger.debug("[RiskPlayer_Player4] Agent module loaded and logging set to DEBUG.")
...
root_agent = LlmAgent(
    ...
    name="RiskPlayer_Player4",
    description="A Risk game player agent that can play turns using MCP tools - specializes in card trading",
    instruction="""
