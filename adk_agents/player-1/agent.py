...
logger.debug("[RiskPlayer_Player1] Agent module loaded and logging set to DEBUG.")
...
root_agent = LlmAgent(
    ...
    name="RiskPlayer_Player1",
    description="A Risk game player agent that can play turns using MCP tools - specializes in aggressive expansion",
    instruction="""
